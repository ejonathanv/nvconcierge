<!-- Vehicles -->
<section class="website__vehicles__carousel">
    <div class="container">
        <div class="owl__vehicles">
            <div class="owl-carousel owl-vehicles">
            ...
            <a href="#" class="owl-vehicles-control owl-vehicles-prev">
                <i class="fa fa-angle-left"></i>
            </a>
            <a href="#" class="owl-vehicles-control owl-vehicles-next">
